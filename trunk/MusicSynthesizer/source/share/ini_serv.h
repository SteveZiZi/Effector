...
private:
	...
	static char *MakeChannelTypeKey(int val);
	static int MakeChannelTypeVal(char *pKey);
	static char *GetHttxProcessName(int SN);

	static int PortSettingParse(struct S_CHANNEL *pChannl, const char *pSetting);
	static int PortSettingParse_Net(struct S_CHANNEL *pChannl, const char *pSetting);
	static int PortSettingParse_Com(struct S_CHANNEL *pChannl, const char *pSetting);
	static int PortSettingPrint(struct S_CHANNEL *pChannl, char *pSetting);
	static int PortSettingPrint_Net(struct S_CHANNEL *pChannl, char *pSetting);
	static int PortSettingPrint_Com(struct S_CHANNEL *pChannl, char *pSetting);
};
