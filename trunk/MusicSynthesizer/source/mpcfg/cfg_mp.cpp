...
/** @berif 配置日志系统 */
const char *GetLogBasePath(void)
{
	return CFG_PATH_LOG;
}
...
//用户进程加在后面
	...
	{MP_PROCESS_HTTX3, "httx3进程，红外或串口通讯"},
	{MP_PROCESS_DBCJ,  "dbcj进程，负责表计能量采集及数据冻结"},
	{MP_PROCESS_PPP,   "ppp进程，负责与主站建立拨号连接"},
	{MP_PROCESS_LCD,   "lcd进程，负责本地操作与显示"},
	{MP_PROCESS_JLCY, "交流采样进程，负责对交采芯片数据采集"},
	{MP_PROCESS_FHKZ, "负荷控制进程，负责对负荷控制数据处理"},
