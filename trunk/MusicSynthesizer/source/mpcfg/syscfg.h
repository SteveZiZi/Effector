...
/** @brief 后台通讯进程总数 */
#define HTTX_PROCESS_MAX	3

/** @brief 串口总数 */
#define SYSTEM_SERIAL_PORT_MAX		64

/** @brief 上下行通道个数定义 */
#define CHANNEL_UP_COUNT	16
#define CHANNEL_DN_COUNT	12

/** @brief 产品宏定义 */
#define CONS_TERM_TYPE_EAC	1
...
/***********************/
	...
	#define CONS_METER_COUNT_MAX		1201 /*表计总量=1200+1;+1那个是为将序号0放弃不用,这样测量点号可以直接当序号使用*/
...
/*系统载波链路类型*/
#define LINKBUS_EASTSOFT	/* 东软载波链路*/
