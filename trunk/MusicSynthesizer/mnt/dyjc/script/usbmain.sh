...
if [ -r $USBROOTDIR/$DEVADDR/$CURDATE.tgz ]; then
	...
	tar -cvf $USBROOTDIR/$DEVADDR/$CURDATE.tgz /mnt/data /mnt/dyjc /mnt/keli >> $USBLOGFILE
...
CURVERFILE=/mnt/keli/sysrun.inf
